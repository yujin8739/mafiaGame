	...
	public String roleDetail(@RequestParam("role") String roleName, Model model) {
	    ...
	    switch (roleName) {
	        case "마피아":
	            ...
	            imagePath = "/godDaddy_etc/introduce/mafia2.png";
	            break;
	        case "스파이":
	            ...
	            imagePath = "/godDaddy_etc/introduce/spy2.png";
	            break;
	        case "의사":
	        ...
	        case "훼방꾼":
	            ...
	            imagePath = "/godDaddy_etc/introduce/saboteur2.png";
	            break;
	        case "도굴꾼":
	        	description = "죽음을 기회로 삼는 그림자 같은 존재.<br>"
	        			+ "첫 사망자의 직업과 팀을 그대로 복사해 그 역할을 이어갑니다.";
	            imagePath = "/godDaddy_etc/introduce/graverobber2.png";
	            break;
	        case "연인":
